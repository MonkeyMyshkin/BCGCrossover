...
p2=ggplot(bayes_eff, aes(x=100*(value),fill=efficacy,col=efficacy)) + geom_density(alpha=0.25) + xlab('% Efficacy') + labs(fill='Mode of Action',col='Mode of Action') + ylab('Posterior Density') + ggtitle('C') + 
  theme(legend.position = c(0.23,0.65))+ theme(text = element_text(size = 10))  
...
p3=ggplot(bayes_R0, aes(x=R0,fill=as.factor(group),col=as.factor(group))) + geom_density(alpha=0.25) + xlab('Experimental R') + labs(fill='Seeder-Sentinel',col='Seeder-Sentinel') + geom_vline(xintercept=1,size=2) + ylab('Posterior Density') + 
...
save.image('../Posterior/dst_post.RData')
```
